...
Public Class Disposisi
    ...
    Sub simpanId()
        If txtid.Text = "" Or txtno.Text = "" Or txtpengirim.Text = "" Or txtperihal.Text = "" Or tglsurat.Text = "" Or tglterima.Text = "" Or tglditeruskan.Text = "" Or instruksi.Text = "" Or cmbjenis.Text = "" Or cmb_diteruskan.Text = "" Or isi_disposisi.Text = "" Then
